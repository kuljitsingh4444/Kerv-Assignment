...
const EducationInfo = ({ updateFiledMetadata }) => {
  ...
  const fieldInfo = useMemo(() => {
    return [
      { field: "collegeName", setter: setCollegeName },
      { field: "collegeLocation", setter: setCollegeLocation },
    ];
  });
  ...
  return (
    <div className="custom-form">
      <div className="form-field">
        <div className="form-key">College Name</div>
        <div>
          <PrimaryInput
            onChange={(e) =>
              updateField(e.target.value, setCollegeName, "collegeName")
            }
            value={collegeName}
          ></PrimaryInput>
        </div>
      ...
      <div className="form-field">
        <div className="form-key">College Location</div>
        <div>
          <PrimaryInput
            onChange={(e) =>
              updateField(e.target.value, setCollegeLocation, "collegeLocation")
            }
