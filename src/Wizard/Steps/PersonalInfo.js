...
const PersonalInfo = ({ updateFiledMetadata }) => {
  ...
  const fieldInfo = useMemo(() => {
    return [
      { field: "name", setter: setName },
      { field: "email", setter: setEmail },
      { field: "contact", setter: setContant },
    ];
  });
  ...
  return (
    <div className="custom-form">
      <div className="form-field">
        ...
        <div>
          <PrimaryInput
            onChange={(e) => updateField(e.target.value, setName, "name")}
            value={name}
          ></PrimaryInput>
        </div>
      </div>
      ...
      <div className="form-field">
        ...
        <div>
          <PrimaryInput
            onChange={(e) => updateField(e.target.value, setEmail, "email")}
            value={email}
          ></PrimaryInput>
        </div>
      </div>
      ...
      <div className="form-field">
        <div className="form-key">Contact</div>
        <div>
          <PrimaryInput
            onChange={(e) => updateField(e.target.value, setContant, "contact")}
            value={contact}
            type={"number"}
          ></PrimaryInput>
        </div>
